...
- How do sales trends change year-wise?
- Which outlet types contribute the most to total sales?
- How does outlet size (Small, Medium, High) impact sales performance?
- Which item types generate the highest revenue?
- What is the sales contribution of low-fat vs regular products?
